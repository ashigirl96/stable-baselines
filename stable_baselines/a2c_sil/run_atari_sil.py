...
def train(env_id, num_timesteps, seed, policy, lr_schedule, num_env,
          sil_update, sil_beta, tb_log_name):
  """
...
def main():
  ...
  parser.add_argument('--tb', type=str, default='/tmp/a2c')
  args = parser.parse_args()
  logger.configure()
  train(args.env, num_timesteps=args.num_timesteps, seed=args.seed, policy=args.policy, lr_schedule=args.lr_schedule,
        num_env=16, sil_update=args.sil_update, sil_beta=args.sil_beta, tb_log_name=args.tb)
